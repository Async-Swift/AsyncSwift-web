  ...
  return (
    <div className="mt-32 sm:grid sm:grid-cols-2 sm:gap-5">
      <div className="flex flex-col items-center justify-center gap-12">
        ...
        <div className="mt">
          <div className="text-3xl text-center text-white font-extralight font-['Montserrat']">
            {subtitle}
          </div>
      ...
      <div className="w-full px-12 py-32">
        <div className="border-[#D9D9D9] border-opacity-50 border border-solid w-full h-full p-10 rounded-lg">
          <div className="text-3xl font-bold text-white text-opacity-80 font-['Montserrat']">
            SyncSwift 2023
          </div>
          ...
          <div className="flex flex-col w-full gap-3 mt-10 text-lg">
            <button className="font-['Montserrat'] bg-[#D9D9D9] bg-opacity-5 border-[#D9D9D9] border-opacity-50 border border-solid h-16 rounded-lg hover:bg-[#D9D9D9] hover:bg-opacity-40">
              get General Ticket
            </button>
            <button className="font-['Montserrat'] bg-[#D9D9D9] bg-opacity-5 border-[#D9D9D9] border-opacity-50 border border-solid h-16 rounded-lg hover:bg-[#D9D9D9] hover:bg-opacity-40">
