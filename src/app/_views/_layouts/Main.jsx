...
export default function Main() {
  return (
    <div className="justify-center px-10 m-auto sm:grid sm:grid-cols-2 sm:gap-5">
      <div className="flex flex-col items-center justify-center gap-12 max-w-[800px] px-6 max-sm:my-60">
        ...
        <div className="mt-12">
          <div className="text-4xl text-center text-white font-mont font-extralight">
            {CONFERENCE.SUBTITLE}
          </div>
          <div className="mt-4 text-2xl font-light text-center text-white text-opacity-50">
            {new Intl.DateTimeFormat("ko-KR").format(new Date(CONFERENCE.DATE))}{" "}
            {CONFERENCE.LOCATION}
          </div>
        </div>
      </div>
      <div className="flex items-center justify-center w-full max-sm:mt-60 max-w-[800px] sm:px-12">
        <div className="flex flex-col justify-center border-[#D9D9D9] border-opacity-50 border border-solid w-full p-10 rounded-lg max-w-[610px] h-[400px] ">
          <div className="text-5xl font-bold text-white text-opacity-80 font-mont">
            SyncSwift 2023
          </div>
          ...
          <div className="flex flex-col w-full gap-5 mt-16 text-3xl">
            <Link
              href={
                "https://smartstore.naver.com/asyncswift/products/9280007233"
              }
              target="_blank"
              className="font-mont bg-[#D9D9D9] bg-opacity-5 border-[#D9D9D9] border-opacity-50 border border-solid h-28 rounded-lg hover:bg-[#D9D9D9] hover:bg-opacity-40"
            >
