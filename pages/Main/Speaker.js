  ...
  const morningAfterSpeakers = [
    {
      ...
      sessionDescription:
        "모바일 개발자의 TDD가 왜 어려운지, 그 어려움들을 어떻게 극복할 수 있는지, 그리고 왜 그럴 가치가 있는지에 관해 이야기합니다.",
      sns: {
    ...
    },
    {
      ...
      sessionDescription:
        "WWDC와 주요 애플 이벤트들을 돌아보며 디자이너들이 왜 애플 디자인에 열광하는지, 무엇에 반응하는지 함께 이야기 나눕니다.",
      sns: {
    ...
    },
    {
      ...
      sessionDescription:
        "주니어 개발자로 입사해서 WWDC 2021에 소개된 Swift concurrency에 적응하면서 알게 된 내용들을 공유합니다.",
      sns: {},
    },
    {
      speakerName: "강훈",
      ...
      sessionDescription: "Modular Architecture 가 무엇인지? 실제 제품에 어떻게 적용할 수 있는지 소개합니다.",
      sns: {
    ...
    },
    {
      ...
      sessionDescription:
        "HIG가 프로덕트와 디자이너에게 미치는 다양한 면에 대해 이야기합니다. 올해 새로운 HIG가 발표되었는데 디자인 분야에서 지속적인 영향력을 미칠 수 있을까요?",
      sns: {
    ...
    },
    {
      ...
      sessionDescription:
        "기획하고, 개발하고, 그리고, 배포하고, 마케팅까지. 다 엉성하지만 그게 개인앱 개발의 매력 아닐까요?",
      sns: {
...
@ POSTECH / Mentee`,
      ...
      sessionDescription:
        "많은 현업에서는 UIKit을 기반으로 앱 서비스를 출시합니다. 기존 레거시 코드, 기능 미지원 등 여러 이유로 SwiftUI 기반 프로젝트가 아직까지 활발하게 진행되고 있지 않은 시기에, 저희는 SwiftUI를 활용해서 앱을 출시 했습니다. 그 과정을 여러분들에게 공유하고 싶습니다.",
      sns: {
...
@ POSTECH / IT manager`,
      ...
      sessionDescription: "첫 한국 애플 스토어 오픈 멤버와 첫 한국 애플 디벨로퍼 아카데미의 오픈 멤버가 된 경험담 공유",
      sns: {
...
@ POSTECH / Mentor`,
      ...
      sessionDescription:
        "iOS 개발을 하다가 위젯을 개발해야할 때 알아야 할 것들과 실제 위젯을 만들면서 했던 삽질의 포인트들을 처음 위젯 개발하는 분들께 공유드립니다. ",
      sns: {
...
@ POSTECH / Mentee`,
      ...
      sessionDescription: "VisionKit을 사용해서 새로운시도를 통해서 만든기능들을 소개하는 세션입니다.",
      sns: {},
    },
    {
      speakerName: "이준영 / 최원혁",
...
@ POSTECH / Mentee`,
      speakerDescription:
        "안녕하세요. 이로운 세상을 만드는 로운입니다.🌱 / 새로움과 놀라움을 좋아하는 개발자입니다. 🧑‍💻",
      sessionTitle: "아카데미 최강 듀오, 기획해 듀오 & 개발해 듀오",
      sessionDescription:
        "기획 : 공대 출신 기획자의 기획 분해와 조립, 대학시절 뜯어본 스마트폰과 아카데미에서 뜯어본 모바일 기기의 다양한 기능과 가능성을 씹고 뜯고 맛보고 즐기기. 개발 : 애플 First-Party Framework의 놀라운 기술들, Nearby interaction과 Multipeer Connectivity 씹고 뜯고 맛보고 즐기기.",
      sns: {
...
@ POSTECH / Mentee`,
      ...
      sessionDescription:
        "AppGroup 과 CoreData Migration 을 통해 앱 뿐만 아니라 위젯과 락스크린에서 데이터를 공유할 수 있습니다. 더 나아가 다음에는 CloudKit 에 대해 알아보도록 하겠습니다! ",
      sns: {
